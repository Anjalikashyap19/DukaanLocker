...
public class MsmeHtmlGenerator {
    ...
    public static String generateCertificateHtml(MsmeParsedData data) {
        ...
        return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">\n" +
                ...
                "  <tr><td></td><td>" + microCheck + "</td><td>" + smallCheck + "</td><td>" + mediumCheck + "</td><td>" + escapeXml(data.getDateOfRegistration() != null ? data.getDateOfRegistration() : "-") + "</td></tr>\n" +
                "</table>\n" +
                "\n" +
                ...
                "  <p class=\"mb-0\" style=\"margin-top:6px;\"><strong>Note:</strong> This is a computer-generated certificate and does not require any physical or digital signature. It is generated based on details furnished by the enterprise on the Udyam Registration portal.</p>\n" +
                "</div>\n" +
                "\n" +
                "<div class=\"footer\">\n" +
                "  Generated and Verified by DukaanLocker on " + printDate + " | This certificate is for informational purposes only\n" +
                "</div>\n" +
                "</body></html>";
    }
